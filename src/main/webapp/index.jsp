...
<li>SockJS:
	...
	<li><a href="chat-sockjs2.jsp">/chat-sockjs.jsp</a>: SockJS 이용 채팅</li>
	<li><a href="chat?roomname=room1">/chat/room1</a>: SockJS 이용 채팅</li>
	<li><a href="room2/chat">/chat-sockjs.jsp</a>: SockJS 이용 채팅</li>
	</ul>
